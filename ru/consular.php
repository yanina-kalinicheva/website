...
<cms:template title='Консульские вопросы'>
	<cms:editable name='header_image' label='Header Image' desc='Upload header image here' type='image' />
	<cms:editable name='greetings' label='Greeting' desc='Enter greetings to the page header' type='text'></cms:editable>
...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Консульские вопросы</title>
    ...
    <body id="page-top">
        ...
        <div class="gray-bg">
          <section class="container ft-cards">
            <div class="row section" style="padding-top: 80px; padding-bottom: 50px">
