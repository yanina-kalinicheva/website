...
<cms:template title='關於代表處' order='10'>
	<cms:editable name='header_image' label='Header Image' desc='Upload header image here' type='image' />
	<cms:editable name='greetings' label='Greeting' desc='Enter greetings to the page header' type='text'>歡迎光臨</cms:editable>
	<cms:editable name='article_image' label='Image' width='750' height='400' type='image' />
	<cms:editable name='article_title' label='Article Title' desc='Enter article title here' type='text'>關於代表處</cms:editable>
          ...
          <div class="container">
              <div class="row">
                ...
                <ol class="col-sm-7 text-right breadcrumb">
                  <li><a href="main.php">主頁</a></li>
                  <li class="active">關於代表處</li>
                </ol>
