...
<cms:template title='About Us' order='9'>
	<cms:editable name='header_image' label='Header Image' desc='Upload header image here' type='image' />
	<cms:editable name='greetings' label='Greeting' desc='Enter greetings to the page header' type='text'>welcome, friend</cms:editable>
          ...
          <div class="container">
              <div class="row">
                ...
                <ol class="col-sm-7 text-right breadcrumb">
                  <li><a href="../mtc_main.html">Home</a></li>
